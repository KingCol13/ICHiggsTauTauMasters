...
namespace ic {
    ...
    double getIPPV_angle(TLorentzVector Tauminus, std::vector<TLorentzVector> sumPionsMinus, TVector3 IP_vect_1, int mva_dm1, TLorentzVector Tauplus, std::vector<TLorentzVector> sumPionsPlus, TVector3 IP_vect_2, int mva_dm2){
...
int main(int argc, char* argv[])
{
    ...
    {   
        ...
        if ((mva_dm1 == 10) && (mva_dm2 == 1))
        {
            ...
            IP_vect_2 = particleToLorentz(pi0_2).Vect();
            ippv_angle = ic::getIPPV_angle(Tauminus, pis_1, IP_vect_1, mva_dm1, Tauplus, pis_2, IP_vect_2, mva_dm2);
        }
        ...
        if ((mva_dm1 == 1) && (mva_dm2 == 10))
        {
            ...
            pis_2 = getPis(pi_2, pi2_2, pi3_2);
            IP_vect_1 = particleToLorentz(pi0_1).Vect();
            ippv_angle = ic::getIPPV_angle(Tauminus, pis_1, IP_vect_1, mva_dm1, Tauplus, pis_2, IP_vect_2, mva_dm2);
        }
