...
tau1_guess4_no_max = Momentum4(tau1_guess4_no_max[0], tau1_guess4_no_max[1], tau1_guess4_no_max[2], tau1_guess4_no_max[3])

tau1_guess4_theta_no_max_dir = [tau1_guess4_theta_no_max.p_x, tau1_guess4_theta_no_max.p_y, tau1_guess4_theta_no_max.p_z]
tau1_guess4_theta_no_max_dir = tau1_guess4_theta_no_max_dir/bf.norm(tau1_guess4_theta_no_max_dir)

tau1_guess4_no_max_dir = [tau1_guess4_no_max.p_x, tau1_guess4_no_max.p_y, tau1_guess4_no_max.p_z]
tau1_guess4_no_max_dir = tau1_guess4_no_max_dir/bf.norm(tau1_guess4_no_max_dir)

plt.title('Sanity check: Tau direction when thetaGJ<thetaGJ_max')

hist = bf.dot_product(tau1_guess4_theta_no_max_dir, tau1_guess4_no_max_dir)

plt.title('Sanity check: tau direction when thetaGJ<theta_max')
bf.plot_1d(hist, 1, 'dot_product(tau1_modif_pola, tau1_pola)', '1', (-0.0001, 0.0001), 500)
plt.show()
raise End



plt.title('Neutrino2 reconstruction - updated polarimetric method\nBest tau p')
plt.plot([-500, 500], [-500, 500], 'k--')
bf.plot_2d(nu_2.p_x, nu_2_guess4.p_x, 'Gen_nu_2_px', 'Best_polarimetric_nu_2.px', (-500, 500), (-500, 500))

plt.title('Neutrino2 reconstruction - updated polarimetric method\nBest tau p')
plt.plot([-500, 500], [-500, 500], 'k--')
bf.plot_2d(nu_2.p_y, nu_2_guess4.p_y, 'Gen_nu_2_py', 'Best_polarimetric_nu_2.py', (-500, 500), (-500, 500))


plt.title('Neutrino2 reconstruction - updated polarimetric method\nBest tau p')
plt.plot([-500, 500], [-500, 500], 'k--')
bf.plot_2d(nu_2.p_z, nu_2_guess4.p_z, 'Gen_nu_2_pz', 'Best_polarimetric_nu_2.pz', (-500, 500), (-500, 500))



plt.title('Neutrino2 - momenta estimates\nClosest p momenta - updated polarimetric method')
bf.plot_1d(nu_2.p_z, nu_2_guess4.p_z, 'Gen_nu_1_p', 'Best_polarimetric_nu_1.p')
bf.plot_1d(nu_2.p_x, nu_2_guess4.p_x, 'Gen_nu_1', 'Best_polarimetric_nu_1.px')
bf.plot_1d(nu_2.p_y, nu_2_guess4.p_y, 'Gen_nu_2_p', 'Best_polarimetric_nu_2.p')
