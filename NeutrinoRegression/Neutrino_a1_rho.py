...
np.savetxt('Config_A.txt', table, fmt = '%.2f')
...
np.savetxt('Config_B.txt', table, fmt = '%.2f')
...
np.savetxt('Config_C.txt', table, fmt = '%.2f')
...
np.savetxt('Config_D.txt', table, fmt = '%.2f')
...
np.savetxt('Config_E.txt', table, fmt = '%.2f')
...
np.savetxt('Config_F.txt', table, fmt = '%.2f')
...
np.savetxt('Config_G.txt', table, fmt = '%.2f')
